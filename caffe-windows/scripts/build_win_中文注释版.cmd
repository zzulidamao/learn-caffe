...
if DEFINED APPVEYOR (
    ...
    if !PYTHON_VERSION! EQU 3 (
        set CONDA_ROOT=E:\anaconda\envs\caffe_py35
    )
...
:: below to use cuDNN
:: cmake配置与生成项目命令 "%~dp0\.."批处理文件上一层目录也就是CMakeLists所在的目录
cmake -G"!CMAKE_GENERATOR!" ^
      ...
      -DCUDNN_ROOT=C:/Program Files/NVIDIA GPU Computing Toolkit/CUDA/v10.2 ^
      "%~dp0\.."
